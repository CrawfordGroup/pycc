"""
CISD length-gauge atomic polar tensors - pycc.apt(pycc.CIderiv(ci)) facade. dipole_derivatives() is inherited from CorrelatedDerivs (the 2n+1 route), driven by CIderiv's density hooks -- no CISD-specific APT code.
...
def test_cisd_lg_apt_translational_sum_rule(cisd_h2o2):
    ...
    density)."""
    comp = pycc.apt(pycc.CIderiv(cisd_h2o2()))
